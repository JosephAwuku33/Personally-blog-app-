            ...
            <form action="">
              <div className="grid md:grid-cols-3 grid-cols-1 gap-4 justify-center items-center">
                ...
                <div className="md:mr-auto mb-6">
                  <button type="submit" className="inline-block px-6 py-2 border-2 border-white text-white font-medium text-xs leading-tight uppercase rounded hover:bg-gray-light :bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
                    Subscribe
                  </button>
                </div>
              </div>
